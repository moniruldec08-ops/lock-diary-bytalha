...
import { Plus, Search, Calendar, Menu, Settings, Trophy, Flame } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-card/80 backdrop-blur-lg shadow-soft border-b border-border">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {streakCount > 0 && (
              <Badge variant="secondary" className="gap-1 px-3 py-1 shadow-soft">
        ...
        <div className="max-w-4xl mx-auto px-4 pb-4">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 py-6 shadow-soft"
            />
          </div>
        </div>
      </header>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          asChild
          size="lg"
          className="rounded-full w-16 h-16 shadow-elevated hover:shadow-glow transition-all hover:scale-110"
        >
          <Link to="/entry/new">
